...
export class OcSpendingAccountService {
    ...
    public ListAssignments(buyerID: string, options?: { spendingAccountID?: string, userID?: string, userGroupID?: string, level?: string, page?: number, pageSize?: number, observe?: any, reportProgress?: boolean}): Observable<any> {
        ...
        if (opts.spendingAccountID === null) {
            throw new Error('Parameter spendingAccountID was null when calling ListAssignments. Null values are not allowed');
        }
        if (opts.userID !== undefined) {
            queryParameters = queryParameters.set('userID', <any>opts.userID);
        }
    ...
    public Patch(buyerID: string, spendingAccountID: string, partialSpendingAccount: SpendingAccount, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        ...
        if (partialSpendingAccount === null || partialSpendingAccount === undefined) {
            throw new Error('Required parameter partialSpendingAccount was null or undefined when calling Patch.');
        }
    ...
    public Save(buyerID: string, spendingAccountID: string, spendingAccount: SpendingAccount, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        ...
        if (spendingAccountID === null || spendingAccountID === undefined) {
            throw new Error('Required parameter spendingAccountID was null or undefined when calling Save.');
        }
        if (spendingAccount === null || spendingAccount === undefined) {
            throw new Error('Required parameter spendingAccount was null or undefined when calling Save.');
        }
     ...
     * @param options.reportProgress flag to report request and response progress.
     */
    public SaveAssignment(buyerID: string, spendingAccountAssignment: SpendingAccountAssignment, options?: { observe?: 'body', reportProgress?: boolean}): Observable<any>;
    public SaveAssignment(buyerID: string, spendingAccountAssignment: SpendingAccountAssignment, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<any>>;
    public SaveAssignment(buyerID: string, spendingAccountAssignment: SpendingAccountAssignment, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<any>>;
    public SaveAssignment(buyerID: string, spendingAccountAssignment: SpendingAccountAssignment, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        let opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
        ...
        if (spendingAccountAssignment === null || spendingAccountAssignment === undefined) {
            throw new Error('Required parameter spendingAccountAssignment was null or undefined when calling SaveAssignment.');
        }
