...
export class OcProductService {
    ...
    */
    public List<TProduct extends Product = Product>(listOptions: { catalogID?: string, categoryID?: string, supplierID?: string, search?: string, searchOn?: Searchable<'Products.List'>, sortBy?: Sortable<'Products.List'>, page?: number, pageSize?: number, filters?: Filters, searchType?: SearchType } = {}, requestOptions: RequestOptions = {} ): Observable<RequiredDeep<ListPageWithFacets<TProduct>>>{
