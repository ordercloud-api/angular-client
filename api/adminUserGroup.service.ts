...
export class AdminUserGroupService {
     ...
     * @param options.reportProgress flag to report request and response progress.
     */
    public Create(group: UserGroup, options?: { observe?: 'body', reportProgress?: boolean}): Observable<UserGroup>;
    public Create(group: UserGroup, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<UserGroup>>;
    public Create(group: UserGroup, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<UserGroup>>;
    public Create(group: UserGroup, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        let opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
     ...
     * 
     * 
     * @param options.search Search of the admin user group.
     * @param options.searchOn Search on of the admin user group.
     * @param options.sortBy Sort by of the admin user group.
     * @param options.page Page of the admin user group.
     * @param options.pageSize Page size of the admin user group.
     * @param options.filters Filters of the admin user group.
     * @param options.observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param options.reportProgress flag to report request and response progress.
     */
   
    public List(options?: { search?: string, searchOn?: Array<string>, sortBy?: Array<string>, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'body', reportProgress?: boolean}): Observable<ListUserGroup>;
    public List(options?: { search?: string, searchOn?: Array<string>, sortBy?: Array<string>, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<ListUserGroup>>;
    public List(options?: { search?: string, searchOn?: Array<string>, sortBy?: Array<string>, page?: number, pageSize?: number, filters?: { [key: string]: string | Array<string>; }, observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<ListUserGroup>>;
     ...
     * @param options.reportProgress flag to report request and response progress.
     */
    public Patch(userGroupID: string, group: UserGroup, options?: { observe?: 'body', reportProgress?: boolean}): Observable<UserGroup>;
    public Patch(userGroupID: string, group: UserGroup, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<UserGroup>>;
    public Patch(userGroupID: string, group: UserGroup, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<UserGroup>>;
    public Patch(userGroupID: string, group: UserGroup, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        let opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
     ...
     * @param options.reportProgress flag to report request and response progress.
     */
    public Update(userGroupID: string, group: UserGroup, options?: { observe?: 'body', reportProgress?: boolean}): Observable<UserGroup>;
    public Update(userGroupID: string, group: UserGroup, options?: { observe?: 'response', reportProgress?: boolean}): Observable<HttpResponse<UserGroup>>;
    public Update(userGroupID: string, group: UserGroup, options?: { observe?: 'events', reportProgress?: boolean}): Observable<HttpEvent<UserGroup>>;
    public Update(userGroupID: string, group: UserGroup, options?: { observe?: any, reportProgress?: boolean}): Observable<any> {
        let opts = options || {};
        if (opts.observe === null || opts.observe === undefined) {
            opts.observe = 'body';
        }
